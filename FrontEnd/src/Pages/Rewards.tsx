      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="md:col-span-2 bg-white dark:bg-gray-700 rounded-2xl shadow-xl p-6 transform transition-all hover:scale-[1.02]">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-amber-700 dark:text-amber-300">Your Rewards Journey</h1>
                  <p className="text-sm text-amber-700 dark:text-amber-300">Badges, achievements, and your progress</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <div className="text-center">
                  ...
                  <div className="text-xs text-amber-700 dark:text-amber-300">Badges Earned</div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-700 rounded-2xl shadow-xl p-6 transform transition-all hover:scale-[1.02]">
            <h2 className="text-xl font-semibold text-amber-700 dark:text-amber-300 mb-4">Quick Tips</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-gray-700 rounded-2xl shadow-xl p-6 transform transition-all hover:scale-[1.01]">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-amber-700 dark:text-amber-300">Earned Badges</h2>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-4">
              {earnedBadges.map((badge) => (
                ...
                >
                  <Badge {...badge} />
                  <span className="text-xs text-amber-700 dark:text-amber-300 mt-2 text-center">{badge.name}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Badges to Earn */}
          <div className="bg-white dark:bg-gray-700 rounded-2xl shadow-xl p-6 transform transition-all hover:scale-[1.01]">
            <h2 className="text-2xl font-bold text-amber-700 dark:text-amber-300 mb-6">Upcoming Badges</h2>
              ...
              {unearnedBadges.map((badge) => (
                ...
                >
                  <div className="flex items-center">
                    <Badge {...badge} />
                    <div className="ml-4">
                      <h3 className="font-semibold text-amber-700 dark:text-amber-300">{badge.name}</h3>
