...
const Badge: React.FC<BadgeProps> = ({ name, description, file }) => {
  ...
  return (
    <div className="relative group">
      <div className="w-16 h-16 rounded-full overflow-hidden shadow-lg transition-transform duration-300 ease-in-out transform group-hover:scale-110 flex items-center justify-center">
        {getBadgeImage(file)}
      </div>
